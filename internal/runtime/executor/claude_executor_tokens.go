...
func (e *ClaudeExecutor) countTokensUpstream(ctx context.Context, auth *cliproxyauth.Auth, req cliproxyexecutor.Request, opts cliproxyexecutor.Options) (cliproxyexecutor.Response, error) {
	...
	if resp.StatusCode < 200 || resp.StatusCode >= 300 {
		...
		if decErr != nil {
			...
			return cliproxyexecutor.Response{}, classifyClaudeUpstreamErrorForModel(upstreamModel, resp.StatusCode, resp.Header, []byte(msg))
		}
		...
		return cliproxyexecutor.Response{}, classifyClaudeUpstreamErrorForModel(upstreamModel, resp.StatusCode, resp.Header, b)
	}
