...
<tbody>
    ...
    <tr>
        ...
        <td>Anthropic Claudeシリーズモデル（Claude Fable、Claude Opus、Claude Sonnetなど）。Claude Fable 5.1は、Anthropicが広く公開している中で最も高性能なモデルであり、高度な推論と長期間のエージェント作業向けに構築されています。</td>
    </tr>
    <tr>
